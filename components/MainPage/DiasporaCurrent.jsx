  ...
  return (
    <div className="items-left md:flex justify-around text-center p-5 hover:bg-slate-500">
      ...
      <div className="items-left md:w-1/2 py-10 md:pl-20">
        <div className="flex text-xl mx-5 py-5 border-b border-gray-400 w-3/5">
        ...
        <div className="flex text-xl mx-5 py-5 border-b border-gray-400 w-3/5 text-start">
          <FaCheck className="mr-5 text-blue-300" />
          Access to your money in 33 countries
        </div>
      </div>
    </div>
  );

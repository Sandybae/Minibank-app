...
const FourthPage = () => {
    return ( 
        <div className="items-center md:flex md:justify-around text-center  hover:bg-green-700 hover:text-white p-5">
            <div className="items-left md:w-1/2 text-left md:pl-20">
                <p className="text-4xl text-gray-700 my-5">Advantage Current Account</p>
                <p className="p-3 sm:text-left font-bold text-4xl my-10 md:w-3/5">Get ahead with investments, insurance and a salary advance added to your banking</p>
            ...
            <div className="items-center md:w-1/2 py-10 pl-20">
                ...
                <div className="flex text-xl mx-5 py-5 border-b border-gray-400 md:w-2/5"><FaCheck className="mr-5 text-blue-300"/>Credit Card</div>
                <div className="flex text-xl mx-5 py-5 border-b border-gray-400 md:w-2/5"><FaCheck className="mr-5 text-blue-300"/>Advance Facility</div>
            </div>
        </div>
     );
}

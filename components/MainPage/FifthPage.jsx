...
const FifthPage = () => {
    return (
        <div className="flex justify-around text-center  hover:bg-gray-800 hover:text-white">
          <div className="w-1/2 hover:bg-gray-600 text-left pl-20">
            <p className="text-4xl text-green-400 my-5">Premier Current Account</p>
            <p className="font-bold text-4xl my-10">Take care of your wealth with the highest level of personal service</p>
          ...
          <div className="w-1/2 py-10 pl-20 hover:bg-gray-600">

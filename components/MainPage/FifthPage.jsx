...
const FifthPage = () => {
    return (
        <div className="items-center md:flex md:justify-around text-center  hover:bg-yellow-700 hover:text-white p-5">
          <div className="items-center md:w-1/2 md:text-left md:pl-20">
            ...
            <p className="p-3 sm:text-left font-bold text-4xl my-10 md:w-3/5">Take care of your wealth with the highest level of personal service</p>

  ...
  return (
    <div className="items-left md:flex md:justify-around text-center  hover:bg-cyan-700 p-5">
      <div className="items-left md:w-1/2 md:text-left md:pl-20">
        ...
        <p className="p-3 text-left font-bold text-4xl my-10 md:w-3/5">
        ...
        <button type="button" className="bg-cyan-900 text-white text-sm rounded text-bold hover:border hover:border-white p-3 mx-2">DOWNLOAD PDF FORM</button>
      </div>
